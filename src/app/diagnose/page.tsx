...
const BASE_URL = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://fjnjvnjfvnfnvjfnvjfnjnjvnjfnvjnvjvnjnvjnjfnj.vercel.app";
            ...
            {currentPage === "prompt" && <article className={promptPageClassNames}>
                <main>
                    ...
                    <section className="record-container">
                        <h2>Click the button to begin your docnote</h2>
